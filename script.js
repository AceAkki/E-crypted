    // JavaScript code for encryption and decryption goes here

    function toggleRandomKey() {
    const randomKeyContainer = document.getElementById("randomKeyContainer");
    const keyInput = document.getElementById("key");
    const randomKeyCheckbox = document.getElementById("randomKey");
...
function generateRandomKey() {
    ...
    // Shuffle the alphabet randomly to create a key
    ...
    // Set the random key as the value of the key input field
